  ...
  return (
    <div>
      <div className="navbar">
        ...
        <a href="/" className="navbar-title" onClick={() => setIsHomePage(true)}>
      ...
      <div className="category-cards">
        <div className="category-card" onClick={(event) => handleCategoryClick('Men',event)}>
          <a href="/men">
            <img src={menIcon} alt="Men" />
            <h3>Men</h3>
          </a>
        </div>
        <div className="category-card" onClick={(event)=> handleCategoryClick('Women',event)}>
          <a href="/women">
            <img src={womenIcon} alt="Women" />
            <h3>Women</h3>
          </a>
        </div>
        <div className="category-card" onClick={(event)=> handleCategoryClick('Kids',event)}>
          <a href="/kids">
      ...
      <div className="brand-section">
        ...
        <div className="brand-cards">
          <div className="brand-card" onClick={(event) => handleCategoryClick('Adidas',event)}>
            <img src={adidas} alt="Adidas" />
          </div>
          <div className="brand-card" onClick={(event) => handleCategoryClick('Puma',event)}>
            <img src={puma} alt="Puma" />
          </div>
          <div className="brand-card" onClick={(event) => handleCategoryClick('Nike',event)}>
            <img src={nike} alt="Nike" />
          </div>
          <div className="brand-card" onClick={(event) => handleCategoryClick('Jordan',event)}>
            <img src={jordan} alt="Jordan" />
          </div>
          <div className="brand-card" onClick={(event) => handleCategoryClick('Reebok',event)}>
      ...
      <div className="search-section">
        <h2>Get Exciting Offers and Upto 50% OFF on the Following Categories </h2>
        <div className="category-cards">
          <div className="category-card" onClick={(event) => handleCategoryClick('Shoes',event)}>
            <a href="/shoes">
              <img src={shoes} alt="Shoes" />
              <h3>Shoes</h3>
            </a>
          </div>
          <div className="category-card" onClick={(event) => handleCategoryClick('T-shirts',event)}>
            <a href="/tshirts">
              <img src={tshirt} alt="T-shirts" />
              <h3>T-shirts</h3>
            </a>
          </div>
          <div className="category-card" onClick={(event) => handleCategoryClick('Joggers',event)}>
            <a href="/jeans">
          ...
          <div className="category-card" onClick={(event) => handleCategoryClick('Caps',event)}>
            <a href="/caps">
